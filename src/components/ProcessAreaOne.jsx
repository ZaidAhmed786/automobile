    ...
    <section className="process-area-1 space position-relative">
      <div className="portfolio-shape-img shape-mockup d-lg-block d-none">
        <img
          ...
          src="assets/images/about/about_shape1-2.svg"
          alt="Fixturbo"
        />
        <img
          className="about1-shape-img-2 spin2"
          src="assets/images/about/about_shape1-1.svg"
          alt="Fixturbo"
        />
      </div>
          ...
          <div className="col-lg-6">
            <div className="title-area text-center">
              ...
              <h2 className="sec-title">
                Dependable Car Repair Solutions You Can Trust
              </h2>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-4 process-card-wrap">
            <div className="process-card">
              ...
              <p className="process-card-text">
                Quick and convenient repair services designed to save time and keep you moving.
              </p>
            </div>
          </div>
          <div className="col-lg-4 process-card-wrap">
            <div className="process-card process-card-center">
              ...
              <p className="process-card-text">
                Accurate diagnostics and expert repairs to restore your vehicle’s performance.
              </p>
            </div>
          </div>
          <div className="col-lg-4 process-card-wrap">
            <div className="process-card">
              ...
              <p className="process-card-text">
                Detail-focused workmanship ensuring safety, durability, and long-term reliability.
              </p>
            </div>
          </div>
        </div>
