          ...
          <div className="col-xxl-7 col-xl-6">
            <div className="about-thumb2 mb-40 mb-xl-0">
              <div className="about-img-1">
                <img src="assets/images/about/about_2-1.png" alt="Fixturbo" />
              </div>
              <div className="about-img-2">
                <img src="assets/images/about/about_2-2.png" alt="Fixturbo" />
              </div>
            ...
            <div className="about-content-wrap">
              <div className="title-area mb-30">
                ...
                <h2 className="sec-title">
                  Reliable Car Repair & Maintenance Solutions{" "}
                  <img
                ...
                <p className="sec-text">
                  We provide professional car repair services to fix mechanical issues, replace damaged parts, and ensure your vehicle runs safely and smoothly. Our experienced technicians focus on accuracy, efficiency, and long-term performance.
                </p>
              </div>
              <div className="about-feature-wrap style-shadow">
                ...
                <div className="about-feature-wrap-details">
                  ...
                  <p className="about-feature-text">
                    Professional repair solutions delivered with precision, reliability, and customer satisfaction at the core{" "}
                  </p>
                </div>
              </div>
              <div className="about-feature-wrap style-shadow">
                ...
                <div className="about-feature-wrap-details">
                  ...
                  <p className="about-feature-text">
                    Advanced tools and skilled mechanics ensuring dependable repairs and smooth vehicle performance{" "}
                  </p>
                </div>
              </div>
            </div>
