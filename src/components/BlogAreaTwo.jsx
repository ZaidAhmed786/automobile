          ...
          >
              ...
              <div>
                <div className="blog-card style2">
                  <div className="blog-img">
                    <img src="/assets/images/blog_s2_1.png" alt="Fixturbo" />
                  ...
                  <div className="blog-content">
                    ...
                    <Link className="link-btn style3" to="/about">
            ...
            <SwiperSlide>
              <div>
                <div className="blog-card style2">
                  <div className="blog-img">
                    <img src="/assets/images/blog_s2_2.png" alt="Fixturbo" />
                    <div className="blog-date">
                      <Link >
                        <span>17</span>Feb
                      </Link>
            ...
            <SwiperSlide>
              <div>
                <div className="blog-card style2">
                  <div className="blog-img">
                    <img src="/assets/images/blog_s2_3.png" alt="Fixturbo" />
                    <div className="blog-date">
                      <Link >
                        <span>17</span>Feb
                      </Link>
