          ...
          >
            <SwiperSlide>
              <div>
                <div className="category-card-item">
                  <img
                    src="assets/images/category1-1.png"
                    alt="Fixturbo"
                  />
            ...
            <SwiperSlide>
              <div>
                <div className="category-card-item">
                  <img
                    src="assets/images/category1-2.png"
                    alt="Fixturbo"
                  />
                  <h6 className="category-card-title">
            ...
            <SwiperSlide>
              <div>
                <div className="category-card-item">
                  <img
                    src="assets/images/category1-5.png"
                    alt="Fixturbo"
                  />
                  <h6 className="category-card-title">
            ...
            <SwiperSlide>
              <div>
                <div className="category-card-item">
                  <img
                    src="assets/images/category1-6.png"
                    alt="Fixturbo"
                  />
                  <h6 className="category-card-title">
            ...
            <SwiperSlide>
              <div>
                <div className="category-card-item">
                  <img
                    src="assets/images/category1-7.png"
                    alt="Fixturbo"
                  />
                  <h6 className="category-card-title">
            ...
            <SwiperSlide>
              <div>
                <div className="category-card-item">
                  <img
                    src="assets/images/category1-8.png"
                    alt="Fixturbo"
                  />
                  <h6 className="category-card-title">
