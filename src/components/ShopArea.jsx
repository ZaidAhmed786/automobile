            ...
            <div className="row gy-4">
              ...
              <div className="col-xl-4 col-md-6">
                <div className="product-card style2">
                  <div className="product-img">
                    <img
                      src="assets/images/services/1-9.png"
                      alt="Fixturbo"
                    />
                  </div>
                  <div className="product-content">
                    <h3 className="product-title">
                      <Link to="/shop ">Precision Ball Bearing</Link>
                    </h3>
                    <span className="star-rating">
                      <i className="fas fa-star" />
                      <i className="fas fa-star" />
          ...
          <div className="col-xl-3 col-lg-4 sidebar-widget-area">
            <aside className="sidebar-sticky-area sidebar-area sidebar-shop">
              ...
              <div className="widget widget_categories  ">
                ...
                <ul>
                  <li>
                    <Link to="/service">Steering wheel</Link>
                    <span>(12)</span>
                  </li>
                  <li>
                    <Link to="/service">Suspension spring</Link>{" "}
                    <span>(12)</span>
                  </li>
                  <li>
                    <Link to="/service">Tail light</Link>
                    <span>(08)</span>
                  </li>
                  <li>
                    <Link to="/service">Transmission</Link>
                    <span>(13)</span>
                  </li>
                  <li>
                    <Link to="/service">Windshield wiper motor</Link>
                    <span>(03)</span>
                  </li>
                  <li>
                    <Link to="/service">Fuel injector</Link>
                    <span>(03)</span>
                  </li>
                  <li>
                    <Link to="/service">Find your product</Link>
                    <span>(03)</span>
                  </li>
                </ul>
              </div>
