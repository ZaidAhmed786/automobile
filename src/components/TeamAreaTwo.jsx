        ...
        <div className="row gx-30 justify-content-between align-items-center">
          <div className="col-lg-4">
            <div className="title-area mb-lg-0">
              ...
              <h2 className="sec-title">Expert Mechanics Behind Our Service</h2>
              <p className="sec-text mb-lg-5 mb-4">
                Our skilled professionals are dedicated to delivering reliable car repair, accurate diagnostics, and high-quality maintenance services you can trust.
              </p>
            ...
            <div className="row gx-30 global-carousel team-slider2">
              ...
              >
                <SwiperSlide>
                  <div className="team-card style2">
                    <div className="team-card_img">
                      <img src="assets/images/about/team-1-1.png" alt="Fixturbo" />
                    </div>
                ...
                <SwiperSlide>
                  <div className="team-card style2">
                    <div className="team-card_img">
                      <img src="assets/images/about/team-1-3.png" alt="Fixturbo" />
                    </div>
                    <div className="team-card_content">
                      <h4 className="team-card_title">
                        <Link to="/team-details">Darrell Steward</Link>
                      </h4>
                      <span className="team-card_desig">Automotive Service Expert</span>
                      <div className="team-social_wrap">
                        <div className="social-btn style2">
                          <Link to="https://linkedin.com/">
                            <i className="fab fa-linkedin-in" />
