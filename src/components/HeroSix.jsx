      ...
      <div className="container">
          ...
          <div className="row flex-row-reverse align-items-center">
            <div className="col-md-6">
              <div className="hero-thumb text-center">
                <img src="assets/images/hero6-1.png" alt="Fixturbo" />
              </div>
            </div>
            <div className="col-md-6">
              <div className="hero-style6">
                <span className="sub-title">Featured Product</span>
                <h1 className="hero-title pb-0 mb-0">Premium Engine Pistons</h1>
                <p>High-performance pistons designed for durability, power, and smooth engine operation.</p>
        ...
        <div className="row gx-30 gy-30">
          ...
          <div className="col-lg-4 col-md-6">
            ...
            >
              <div className="intro-card-img">
                <img src="assets/images/hero6-3.png" alt="Fixturbo" />
              </div>
              <div className="intro-card-details">
                <h6 className="intro-card-subtitle">save up to $5.00</h6>
                <h4 className="intro-card-title">
                  <Link to="#">Pistons & Mechanical Parts</Link>
                </h4>
                <Link to="/shop" className="btn style5 style-radius">
                  Shop Now
                  <i className="fas fa-arrow-right ms-2" />
          ...
          <div className="col-lg-4 col-md-6">
            <div className="hero-intro-card bg-theme">
              <div className="intro-card-img">
                <img src="assets/images/hero6-4.png" alt="Fixturbo" />
              </div>
              <div className="intro-card-details">
                ...
                <h4 className="intro-card-title text-white">
                  <Link to="#">Heavy-Duty Engine Components</Link>
                </h4>
                <Link to="/shop" className="btn style5 style-radius">
                  Shop Now
                  <i className="fas fa-arrow-right ms-2" />
